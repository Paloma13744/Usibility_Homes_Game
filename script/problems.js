...
const usabilityProblems = [
    {
        ...
        description: 'O cliente efetuou uma compra no site, mas não encontrou o seu produto na aba de pedidos. Qual heurística de usabilidade o site pode utilizar para evitar que esse erro ocorra novamente?',
    ...
    },
    {
        ...
        description: 'Vendedor percebeu que houve uma queda nos acessos do site após a mudança no layout do site para uma proposta que o diferenciasse dos concorrentes. A falta de qual heurística pode ser a razão para essa queda?',
    ...
    },
    {
        ...
        description: 'A interface do jogo está tão cheia de informações, barras e botões que fica difícil focar no que realmente importa. Qual heurística de usabilidade está sendo ignorada?',
    ...
    },
    {
        ...
        description: 'O sistema de runas apresenta diversos símbolos, informações ocultas e opções que nem sempre estão claras para jogadores novos. Qual princípio de usabilidade ajudaria a resolver esse problema?',
    ...
    },
    {
        ...
        description: 'Após tocar no botão “Enviar PIX”, a tela mostra apenas um círculo girando com a palavra Processando… por mais de 40 segundos. Não há barra de progresso, porcentagem, estimativa de tempo nem confirmação parcial (como “Etiqueta de envio criada”).',
        correctHeuristicId: '1',
        options: [
            { id: '1', text: 'Visibilidade do Status do Sistema' },
    ...
    },
    {
        ...
        description: 'Para acessar a conta, o aplicativo exige que o usuário digite manualmente o código da agência (ex.: 3414), sem fornecer um filtro de busca, lista suspensa ou sugestão automática para encontrar a agência correta. Como resultado, muitos usuários precisam sair do app para procurar essa informação em outro lugar, o que prejudica a experiência. Qual heurística está sendo violada?',
        correctHeuristicId: '6',
        options: [
            { id: '5', text: 'Prevenção de erros' },
            { id: '2', text: 'Correspondência entre sistema e mundo real' },
    ...
    },
    {
        ...
        description: 'Na tela inicial há três botões: TED, DOC e PIX. Nenhum deles traz rótulo descritivo ou ícone que explique as diferenças (prazo, horário, tarifa). Usuários novatos confundem as opções e escolhem a errada. Qual heurística está sendo violada?.',
    ...
    {
        company: 'agencia',
        problemImage: 'https://via.placeholder.com/400x200/0000FF/FFFFFF?text=Icones+Confusos', // Idealmente usar assets locais
        description: `Usuários frequentes, como consultores que voam toda semana na mesma rota,
            ...
            O site não oferece: Botão “Repetir reserva anterior”; Perfis salvos de passageiro;
            Autopreenchimento de CPF ou programa de milhas; Atalhos de teclado (Tab/Enter) para avançar.
    ...
    },
    {
        ...
        description: `“Onde clico agora?”
            Busca de voos: Interface segue o design-guide do banco de cores da marca: botão primário verde “Pesquisar” fixado na parte inferior da tela.
            Navegação principal em abas inferiores (Ínicio ✈ Minhas viagens 💳 Perfil).
            Página de resultados: O botão de ação vira azul e sobe para o canto superior direito com o texto “Selecionar” (sem ícone).
            A barra de navegação desaparece; para voltar o usuário depende de um pequeno “< Voltar”.
            Resumo da reserva: O mesmo botão reaparece laranja, texto em inglês “Checkout”, agora posicionado no centro, logo acima do preço.
            Datas mudam de “10/07/2025” (dd/mm/aaaa) para “Jul 10, 2025” e a moeda troca de R$ 1.298,50 para USD 1,298.50.
            Pagamento: A navegação retorna, mas no topo, com um ícone de hambúrguer ☰; o botão final é cinza “Finalizar” em maiúsculas.
    ...
    },
    {
        ...
        description: 'Um estudante tenta se matricular online, mas o sistema exibe uma mensagem de erro: “Você está inapto para realizar a matrícula. Entre em contato com sua unidade escolar.” A mensagem não explica o motivo, nem oferece orientações para resolver o problema. Qual heurística de Nielsen está sendo violada?',
        correctHeuristicId: '9',
        options: [
            { id: '1', text: 'Visibilidade do estado do sistema' },
    ...
    },
    {
        ...
        description: 'Durante o pagamento em um app de restaurante, o usuário tenta inserir os dados do cartão, mas o teclado não aparece. Não há mensagem de erro, nem resposta do sistema, impedindo a conclusão da compra. Qual heurística de usabilidade de Nielsen está sendo violada nesse caso?',
        correctHeuristicId: '1',
        options: [
            { id: '4', text: 'Consistência e padronização' },
            { id: '1', text: 'Visibilidade do estado do sistema' },
    ...
    },
    {
        ...
        description: 'O usuário tenta acessar a área do Clube do restaurante no aplicativo, mas encontra uma tela vermelha com a mensagem "Oops, tivemos um probleminha". Como resultado, ele não consegue utilizar os benefícios do clube e perde pontos. Qual heurística de usabilidade de Nielsen está sendo violada nesse caso?',
        correctHeuristicId: '1',
        options: [
            { id: '1', text: 'Visibilidade do estado do sistema' },
            { id: '8', text: 'Estética e design minimalista' },
